...
import 'package:fakestore/app/features/home/data/repository/slider_api_repository.dart';
import 'package:fakestore/app/features/home/data/repository/slider_db_repository.dart';
import 'package:fakestore/app/features/home/services/slider_service.dart';
...
void configureDependencies() {
  ...
  getIt.registerLazySingleton<AuthApiRepository>(
      () => AuthApiRepository(getIt<ApiClient>()));
  getIt.registerLazySingleton<AuthService>(
      () => AuthService(getIt<AuthApiRepository>()));

  // Slider
  getIt.registerLazySingleton<SliderApiRepository>(
      () => SliderApiRepository(getIt<ApiClient>()));
  getIt.registerLazySingleton<SliderDBRepository>(
      () => SliderDBRepository(getIt<AppDatabase>()));
  ...
  // Category
  getIt.registerLazySingleton<CategoryDbRepository>(
      () => CategoryDbRepository(getIt<AppDatabase>()));
  getIt.registerLazySingleton<CategoryApiRepository>(
      () => CategoryApiRepository(getIt<ApiClient>()));
  ...
  // Product
  getIt.registerLazySingleton<ProductDbRepository>(
      () => ProductDbRepository(getIt<AppDatabase>()));
  getIt.registerLazySingleton<ProductApiRepository>(
      () => ProductApiRepository(getIt<ApiClient>()));
  ...
  // Cart
  getIt.registerLazySingleton<CartDbRepository>(
      () => CartDbRepository(getIt<AppDatabase>()));
  getIt.registerLazySingleton<CartApiRepository>(
      () => CartApiRepository(getIt<ApiClient>()));
  getIt.registerLazySingleton<CartService>(() => CartService(
        getIt<CartDbRepository>(),
        getIt<CartApiRepository>(),
      ));
  // Favorite
  getIt.registerLazySingleton<FavoriteDbRepository>(
      () => FavoriteDbRepository(getIt<AppDatabase>()));
  getIt.registerLazySingleton<FavoriteApiRepository>(
      () => FavoriteApiRepository(getIt<ApiClient>()));
